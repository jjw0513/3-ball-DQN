...
parser.add_argument('--batch-size', type=int, default=50, metavar='B', help='Batch size')  # Dreamer: 50
parser.add_argument('--learning-rate', type=float, default=2e-4, metavar='LR', help='Learning rate')  # Dreamer: 2e-4
parser.add_argument('--epsilon-start', type=float, default=1, metavar='ES', help='Start of epsilon')  # Keep original
parser.add_argument('--epsilon-end', type=float, default=0.0, metavar='EE', help='End of epsilon')  # Dreamer: 0.0
parser.add_argument('--epsilon-decay', type=int, default=200000, metavar='ED', help='Epsilon decay')  # Dreamer: 200000
parser.add_argument('--replay-memory-size', type=int, default=1000000, metavar='RMS', help='Replay memory size')  # Dreamer: 1000000
parser.add_argument('--gamma', type=float, default=0.999, metavar='G', help='Discount factor')  # Dreamer: 0.999
parser.add_argument('--target-update-iter', type=int, default=16, metavar='TUI', help='Target network update interval')  # Dreamer: 16
parser.add_argument('--max-steps', type=int, default=1000, metavar='MS', help='Maximum number of steps per episode')  # Dreamer: 1000
parser.add_argument('--episodes', type=int, default=1000, metavar='E', help='Total number of episodes')  # Dreamer: 1000
parser.add_argument('--env', type=str, default='GymMoreRedBalls-v0', help='Gym environment')  # Keep original
...
parser.add_argument('--disable-cuda', type=str, default='False', help='disable_cuda')
